...
class APCI1500:
    ...
    def _define_functions(self):
        ...
        self.i_PCI1500_Set16DigitalOutputsOn.argtypes = [ctypes.c_void_p, ctypes.c_ushort]
    ...
    def set_all_outputs_off(self, board_handle):
        ...
        :return: Error code if any, 0 if successful.
        """
        result = self.i_PCI1500_Set16DigitalOutputsOff(board_handle, 0xFFFF)
    ...
    def set_all_outputs_on(self, board_handle):
        ...
        :return: Error code if any, 0 if successful.
        """
        result = self.i_PCI1500_Set16DigitalOutputsOn(board_handle, 0xFFFF)
