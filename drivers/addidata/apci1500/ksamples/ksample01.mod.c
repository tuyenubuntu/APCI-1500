...
__used __section("__versions") = {
	{ 0x317b9d6d, "i_APCI1500_StopInputEvent" },
	...
	{ 0xd191623a, "i_APCI1500_SetInputEventMask" },
	{ 0x25a36a6, "i_APCI1500_StartInputEvent" },
...
MODULE_INFO(srcversion, "9A7D037AB617E54401015D7");
